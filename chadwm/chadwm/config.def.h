...
static const char *fonts[]          = {"Maple Mono NF:style:medium:size=10" };
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,                 XK_m,       spawn,          SHCMD("rofi -modi \"emoji:rofimoji\" -show emoji") },
    { MODKEY,                           XK_Return,  spawn,          SHCMD("st")},
    { MODKEY|ShiftMask,                 XK_Return,  spawn,          SHCMD("ghostty")},
    { MODKEY|ShiftMask,                 XK_n,  spawn,               SHCMD("feh --bg-fill --no-fehbg --randomize ~/Pictures/wallpapers/pixiv/2020/")},
